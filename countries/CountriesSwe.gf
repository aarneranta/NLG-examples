...
lin 'U.S._Virgin_Islands_Country' = mkCountry "Amerikanska Jungfruöarna" ;
...
lin American_Samoa_Country = mkCountry "Amerikanska Samoa" ;
...
lin Armenia_Country = mkCountry "Armenien" ;
...
lin Bulgaria_Country = mkCountry "Bulgarien" ;
...
lin East_Timor_Country = mkCountry "Östtimor" ;
...
lin Ethiopia_Country = mkCountry "Etiopien" ;
lin Falkland_Islands_Country = mkCountry "Falklandöarna" ;
lin Faroe_Islands_Country = mkCountry "Färöarna" ;
...
lin Kyrgyzstan_Country = mkCountry "Kirgizistan" ;
...
lin Macedonia_Country = mkCountry "Macedonien" ;
lin Madagascar_Country = mkCountry "Madagaskar" ;
...
lin Marshall_Islands_Country = mkCountry "Marshallöarna" ;
...
lin Moldova_Country = mkCountry "Moldavien" ;
lin Monaco_Country = mkCountry "Monaco" ;
lin Mongolia_Country = mkCountry "Mongoliet" ;
...
lin New_Zealand_Country = mkCountry "Nya Zeeland" ;
...
lin Philippines_Country = mkCountry "Filippinerna" ;
...
lin Republic_of_the_Congo_Country = mkCountry "Kongo-Brazzaville" ;
...
lin Saudi_Arabia_Country = mkCountry "Saudiarabien" ;
lin Senegal_Country = mkCountry "Senegal" ;
lin Serbia_Country = mkCountry "Serbien" ;
lin Serbia_and_Montenegro_Country = mkCountry "Serbien och Montenegro" ;
...
lin Solomon_Islands_Country = mkCountry "Solomonöarna" ;
lin Somalia_Country = mkCountry "Somalia" ;
lin South_Africa_Country = mkCountry "Sydfrika" ;
...
lin South_Sudan_Country = mkCountry "Sydsudan" ;
...
lin Tunisia_Country = mkCountry "Tunisien" ;
...
lin Western_Sahara_Country = mkCountry "Västsahara" ; ----
...
lin East_Jerusalem_City = mkCity "Östra Jerusalem" ; ----
...
lin Vatican_City_City = mkCity "Vatikanstaden" ;
...
lin Warsaw_City = mkCity "Warzsawa" ;
