concrete CountriesSwe of Countries =
...
----    = \n,cn -> mkNP (symb <n : Symb>) (P.mkAdv (mkUtt (mkNP aPl_Det cn).s)) ; ---
  ...
  largest_Det = S.mkDet the_Quant (S.mkOrd L.big_A) ;
  smallest_Det = S.mkDet the_Quant (S.mkOrd L.small_A) ;
...
lin
  ...
  world_Continent = mkNP the_Det (mkN "värld") ;
...
lin Copenhagen_Capital = mkCapital "Köpenhamn" ;
...
lin Helsinki_Capital = mkCapital "Helsingfors" ;
...
lin Rome_Capital = mkCapital "Rom" ;
...
lin AF_Continent = mkContinent "Afrika" ;
lin AN_Continent = mkContinent "Antarktis" ;
lin AS_Continent = mkContinent "Asien" ;
lin EU_Continent = mkContinent "Europa" ;
lin NA_Continent = mkContinent "Nordamerika" ;
lin OC_Continent = mkContinent "Oceanien" ;
lin SA_Continent = mkContinent "Sydamerika" ;
