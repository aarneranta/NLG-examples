...
oper
  islandsCountry : Str -> PlaceExp
    = \s -> mkCountry (mkNP thePl_Det (mkN s (mkN "saari" "saaria"))) False ;
  islandCountry : Str -> PlaceExp
    = \s -> mkCountry (mkNP the_Det (mkN s (mkN "saari" "saaria"))) False ;
...
lin 'U.S._Virgin_Islands_Country' = islandsCountry "Yhdysvaltain Neitsyt" ;
...
lin Cambodia_Country = mkCountry "Kambodža" ;
lin Cameroon_Country = mkCountry "Kamerun" ;
...
lin Christmas_Island_Country = islandCountry "Joulu" ;
lin Cocos_Islands_Country = islandsCountry "Kookos" ;
lin Colombia_Country = mkCountry "Kolumbia" ;
lin Comoros_Country = mkCountry (mkNP thePl_Det (mkN "Komori")) False ;
lin Cook_Islands_Country = islandsCountry "Cookin" ;
...
lin Czech_Republic_Country = mkCountry "Tšekki" ;
...
lin Dominican_Republic_Country = mkCountry (mkNP (mkCN (mkA "Dominikaaninen") (mkN "tasavalta"))) True ;
...
lin Falkland_Islands_Country = islandsCountry "Falkland-" ;
lin Faroe_Islands_Country = islandsCountry "Fär" ;
lin Fiji_Country = mkCountry "Fidži" ;
lin Finland_Country = mkCountry (mkN "Suomi" "Suomen" "Suomia") ;
...
lin Hong_Kong_Country = mkCountry "Hongkong" ;
...
lin Isle_of_Man_Country = islandCountry "Man-" ;
lin Israel_Country = mkCountry "Israel" ;
lin Italy_Country = mkCountry "Italia" ;
lin Ivory_Coast_Country = mkCountry "Norsunluurannikko" ;
...
lin Kazakhstan_Country = mkCountry "Kazakstan" ;
...
lin Marshall_Islands_Country = islandsCountry "Marshall-" ;
...
lin Palestinian_Territory_Country = mkCountry "Palestiina" ;
...
lin Philippines_Country = mkCountry (mkNP thePl_Det (mkN "Filippiini")) False ;
lin Pitcairn_Country = mkCountry "Pitcairn" ;
lin Poland_Country = mkCountry "Puola" ;
lin Portugal_Country = mkCountry "Portugali" ;
...
lin Seychelles_Country = mkCountry (mkNP thePl_Det (mkN "Seychelli")) False ;
...
lin Turkey_Country = mkCountry (mkN "Turkki") ;
...
lin Vatican_Country = mkCountry "Vatikaanivaltio" ;
...
lin Western_Sahara_Country = mkCountry "Länsi-Sahara" ;
...
lin Beijing_City = mkCity "Peking" ;
lin Beirut_City = mkCity "Beirut" ;
lin Belgrade_City = mkCity "Belgrad" ;
lin Belmopan_City = mkCity "Belmopan" ;
lin Berlin_City = mkCity "Berliini" ;
lin Berne_City = mkCity "Bern" ;
...
lin Copenhagen_City = mkCity "Kööpenhamina" ;
lin Dakar_City = mkCity "Dakar" ;
lin Damascus_City = mkCity "Damaskos" ;
...
lin East_Jerusalem_City = mkCity "Itä-Jerusalem" ;
...
lin Havana_City = mkCity "Havanna" ;
lin Helsinki_City = mkNP (mkN "Helsinki") ;
lin Hong_Kong_City = mkCity "Hongkong" ;
...
lin Moscow_City = mkCity "Moskova" ;
...
lin Tehran_City = mkCity "Teheran" ;
...
lin Vatican_City_City = mkCity "Vatikaani" ;
lin Victoria_City = mkCity "Victoria" ;
lin Vienna_City = mkCity "Wien" ;
lin Vientiane_City = mkCity "Vientiane" ;
lin Vilnius_City = mkCity "Vilna" ;
lin Warsaw_City = mkCity "Varsova" ;
...
lin Yerevan_City = mkCity "Jerevan" ;
...
lin Yuan_Renminbi_CurrencyName = mkCurrencyName "yuan" ;
