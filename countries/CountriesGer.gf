concrete CountriesGer of Countries = CountriesFunctor 
...
oper
  ...
  capital_CN = mkCN (mkN "Hauptstadt" "Hauptstädte" feminine) ;
  country_CN = mkCN (mkN "Land" "Länder" neuter) ;
  population_CN = mkCN (mkN "Einwohnerzahl" feminine) ;
  currency_CN = mkCN (mkN "Währung") ;
  inhabitant_CN = mkCN (mkN "Einwohner") ;
  area_CN = mkCN (mkN "Fläche") ;
  square_kilometre_CN = mkCN (mkN "Quadratkilometer") ;
  world_CN = mkCN (mkN "Welt" feminine) ;
  
  average_A = mkA "durchschnittlich" ;
  total_A = mkA "gesamt" ;
...
lin Algeria_Country = mkCountry "Algerien" ;
...
lin Antigua_and_Barbuda_Country = mkCountry "Antigua und Barbuda" ;
lin Argentina_Country = mkCountry "Argentinien" ;
...
lin Bangladesh_Country = mkCountry "Bangladesch" ;
...
lin Bolivia_Country = mkCountry "Bolivien" ;
...
lin Cambodia_Country = mkCountry "Kambodscha" ;
...
lin Central_African_Republic_Country = mkCountry "Zentralafrikanische Republik" ;
lin Chad_Country = mkCountry "Tschad" ;
...
lin Comoros_Country = mkCountry "Komoren" ;
...
lin Democratic_Republic_of_the_Congo_Country = mkCountry "Demokratische Republik Kongo" ;
lin Denmark_Country = mkCountry "Denmark" ;
lin Djibouti_Country = mkCountry "Dschibuti" ;
lin Dominica_Country = mkCountry "Dominica" ;
lin Dominican_Republic_Country = mkCountry "Dominikanische Republik" ;
lin East_Timor_Country = mkCountry "Osttimor" ;
lin Ecuador_Country = mkCountry "Ecuador" ;
lin Egypt_Country = mkCountry "Ägypten" ;
...
lin Fiji_Country = mkCountry "Fidschi" ;
lin Finland_Country = mkCountry "Finnland" ;
...
lin Greece_Country = mkCountry "Griechenland" ;
...
lin Maldives_Country = mkCountry "Malediven" ;
...
lin Netherlands_Country = mkCountry "Niederlande" ;
...
lin Norway_Country = mkCountry "Norwegen" ;
...
lin Papua_New_Guinea_Country = mkCountry "Papua-Neuguinea" ;
...
lin Saint_Kitts_and_Nevis_Country = mkCountry "St. Kitts und Nevis" ;
lin Saint_Lucia_Country = mkCountry "St. Lucia" ;
lin Saint_Martin_Country = mkCountry "Saint Martin" ;
lin Saint_Pierre_and_Miquelon_Country = mkCountry "Saint Pierre and Miquelon" ;
lin Saint_Vincent_and_the_Grenadines_Country = mkCountry "St. Vincent und die Grenadinen" ;
...
lin Seychelles_Country = mkCountry "Seychellen" ;
lin Sierra_Leone_Country = mkCountry "Sierra Leone" ;
lin Singapore_Country = mkCountry "Singapur" ;
lin Sint_Maarten_Country = mkCountry "Sint Maarten" ;
lin Slovakia_Country = mkCountry "Slowakei" ;
lin Slovenia_Country = mkCountry "Slovenia" ;
lin Solomon_Islands_Country = mkCountry "Salomonen" ;
lin Somalia_Country = mkCountry "Somalia" ;
lin South_Africa_Country = mkCountry "Südafrika" ;
...
lin South_Sudan_Country = mkCountry "Südsudan" ;
...
lin Sweden_Country = mkCountry "Schweden" ;
lin Switzerland_Country = mkCountry "Switzerland" ;
lin Syria_Country = mkCountry "Syrien" ;
lin Taiwan_Country = mkCountry "Republik China" ;
lin Tajikistan_Country = mkCountry "Tadschikistan" ;
...
lin Trinidad_and_Tobago_Country = mkCountry "Trinidad und Tobago" ;
...
lin United_Arab_Emirates_Country = mkCountry "Vereinigte Arabische Emirate" ;
lin United_Kingdom_Country = mkCountry "Vereinigtes Königreich" ;
...
lin Uzbekistan_Country = mkCountry "Usbekistan" ;
...
lin Zimbabwe_Country = mkCountry "Simbabwe" ;
...
lin Algiers_City = mkCity "Algier" ;
...
lin Guatemala_City_City = mkCity "Guatemala-Stadt" ;
...
lin Mexico_City_City = mkCity "Mexiko-Stadt" ;
...
lin Pyongyang_City = mkCity "Pjöngjang" ;
...
lin Taipei_City = mkCity "Taipeh" ;
lin Tallinn_City = mkCity "Tallinn" ;
lin Tarawa_City = mkCity "Tarawa" ;
lin Tashkent_City = mkCity "Taschkent" ;
...
lin Warsaw_City = mkCity "Warschau" ;
...
lin SA_Continent = mkCountry "Südamerika" ;
...
lin Pound_CurrencyName = mkCurrencyName "Pfund" ;
