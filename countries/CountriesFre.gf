concrete CountriesFre of Countries = CountriesFunctor
 - [ContinentArticle,
    CountryCityLocation,
    inContinent
   ]
...
oper inContinent : {np : NP ; incases : Bool} -> Adv = \co -> case co.incases of {
    True => S.mkAdv (mkPrep "en") co.np ;
    _ => S.mkAdv dative co.np
    } ;
...
oper
  ...
  country_CN = mkCN (mkN "pays") ;
  population_CN = mkCN (mkN "population") ;
  currency_CN = mkCN (mkN "monnaie") ;
  inhabitant_CN = mkCN (mkN "habitant") ;
  area_CN = mkCN (mkN "superficie") ;
  square_kilometre_CN = mkCN (mkA "carré") (mkN "kilomètre" masculine) ;
  world_CN = mkCN (mkN "monde" masculine) ;
...
lin 'Guinea-Bissau_Country' = mkCountry "Guinée-Bissau" ;
...
lin Brazil_Country = mkCountry "Brésil" ;
...
lin Cambodia_Country = mkCountry "Cambodge" ;
lin Cameroon_Country = mkCountry "Cameroon" ;
lin Canada_Country = mkCountry "Canada" ;
lin Cape_Verde_Country = mkCountry "Cap-Vert" ;
lin Cayman_Islands_Country = mkCountry "Cayman Islands" ;
lin Central_African_Republic_Country = mkCountry "République centrafricaine" ;
...
lin Comoros_Country = mkCountry "Comores" ;
...
lin Democratic_Republic_of_the_Congo_Country = mkCountry "République démocratique du Congo" ;
lin Denmark_Country = mkCountry "Denmark" ;
lin Djibouti_Country = mkCountry "Djibouti" ;
lin Dominica_Country = mkCountry "Dominique" ;
lin Dominican_Republic_Country = mkCountry "République dominicaine" ;
lin East_Timor_Country = mkCountry "Timor oriental" ;
lin Ecuador_Country = mkCountry "Ecuador" ;
lin Egypt_Country = mkCountry "Égypte" ;
lin El_Salvador_Country = mkCountry "Salvador" ;
lin Equatorial_Guinea_Country = mkCountry "Equatorial Guinea" ;
lin Eritrea_Country = mkCountry "Érythrée" ;
...
lin Fiji_Country = mkCountry "Fidji" ;
lin Finland_Country = mkCountry "Finlande" ;
...
lin Greece_Country = mkCountry "Grèce" ;
lin Greenland_Country = mkCountry "Greenland" ;
lin Grenada_Country = mkCountry "Grenade" ;
...
lin Guinea_Country = mkCountry "Guinée" ;
...
lin Indonesia_Country = mkCountry "Indonésie" ;
...
lin Israel_Country = mkCountry "Israël" ;
lin Italy_Country = mkCountry "Italie" ;
lin Ivory_Coast_Country = mkCountry "Ivory Coast" ;
lin Jamaica_Country = mkCountry "Jamaïque" ;
lin Japan_Country = mkCountry "Japan" ;
lin Jersey_Country = mkCountry "Jersey" ;
lin Jordan_Country = mkCountry "Jordanie" ;
...
lin Libya_Country = mkCountry "Libye" ;
...
lin Mauritania_Country = mkCountry "Mauritanie" ;
lin Mauritius_Country = mkCountry "Maurice" ;
lin Mayotte_Country = mkCountry "Mayotte" ;
lin Mexico_Country = mkCountry "Mexique" ;
...
lin Montenegro_Country = mkCountry "Monténégro" ;
lin Montserrat_Country = mkCountry "Montserrat" ;
lin Morocco_Country = mkCountry "Maroc" ;
lin Mozambique_Country = mkCountry "Mozambique" ;
lin Myanmar_Country = mkCountry "Birmanie" ;
lin Namibia_Country = mkCountry "Namibie" ;
lin Nauru_Country = mkCountry "Nauru" ;
lin Nepal_Country = mkCountry "Népal" ;
lin Netherlands_Antilles_Country = mkCountry "Netherlands Antilles" ;
lin Netherlands_Country = mkCountry "Pays-Bas" ;
...
lin Saint_Kitts_and_Nevis_Country = mkCountry "Saint-Christophe-et-Niévès" ;
lin Saint_Lucia_Country = mkCountry "Sainte-Lucie" ;
lin Saint_Martin_Country = mkCountry "Saint Martin" ;
lin Saint_Pierre_and_Miquelon_Country = mkCountry "Saint Pierre and Miquelon" ;
lin Saint_Vincent_and_the_Grenadines_Country = mkCountry "Saint-Vincent-et-les-Grenadines" ;
...
lin Singapore_Country = mkCountry "Singapour" ;
lin Sint_Maarten_Country = mkCountry "Sint Maarten" ;
lin Slovakia_Country = mkCountry "Slovaquie" ;
lin Slovenia_Country = mkCountry "Slovenia" ;
lin Solomon_Islands_Country = mkCountry "Îles Salomon" ;
lin Somalia_Country = mkCountry "Somalia" ;
lin South_Africa_Country = mkCountry "Afrique du Sud" ;
...
lin South_Sudan_Country = mkCountry "Soudan du Sud" ;
lin Spain_Country = mkCountry "Spain" ;
lin Sri_Lanka_Country = mkCountry "Sri Lanka" ;
lin Sudan_Country = mkCountry "Soudan" ;
...
lin Sweden_Country = mkCountry "Suède" ;
lin Switzerland_Country = mkCountry "Suisse" ;
lin Syria_Country = mkCountry "Syrie" ;
lin Taiwan_Country = mkCountry "Taïwan" ;
lin Tajikistan_Country = mkCountry "Tadjikistan" ;
lin Tanzania_Country = mkCountry "Tanzania" ;
lin Thailand_Country = mkCountry "Thaïlande" ;
lin Togo_Country = mkCountry "Togo" ;
lin Tokelau_Country = mkCountry "Tokelau" ;
lin Tonga_Country = mkCountry "Tonga" ;
lin Trinidad_and_Tobago_Country = mkCountry "Trinité-et-Tobago" ;
lin Tunisia_Country = mkCountry "Tunisia" ;
lin Turkey_Country = mkCountry "Turkey" ;
lin Turkmenistan_Country = mkCountry "Turkménistan" ;
lin Turks_and_Caicos_Islands_Country = mkCountry "Turks and Caicos Islands" ;
lin Tuvalu_Country = mkCountry "Tuvalu" ;
lin Uganda_Country = mkCountry "Ouganda" ;
lin Ukraine_Country = mkCountry "Ukraine" ;
lin United_Arab_Emirates_Country = mkCountry "Émirats arabes unis" ;
lin United_Kingdom_Country = mkCountry "Royaume-Uni" ;
...
lin 'St._George\'s_City' = mkCity "Saint-Georges" ;
lin 'St._John\'s_City' = mkCity "St. John's" ;
lin Abu_Dhabi_City = mkCity "Abou Dabi" ;
...
lin Cairo_City = mkCity "Le Caire" ;
...
lin Damascus_City = mkCity "Damas" ;
...
lin Dushanbe_City = mkCity "Douchanbé" ;
...
lin Jerusalem_City = mkCity "Jérusalem" ;
lin Juba_City = mkCity "Djouba" ;
lin Kabul_City = mkCity "Kaboul" ;
lin Kampala_City = mkCity "Kampala" ;
lin Kathmandu_City = mkCity "Katmandou" ;
...
lin London_City = mkCity "Londres" ;
...
lin Mexico_City_City = mkCity "Mexico" ;
...
lin N'Djamena_City = mkCity "N'Djaména" ;
...
lin Port_of_Spain_City = mkCity "Port-d'Espagne" ;
...
lin Santo_Domingo_City = mkCity "Saint-Domingue" ;
...
lin Tashkent_City = mkCity "Tachkent" ;
...
lin Thimphu_City = mkCity "Thimphou" ;
...
lin AF_Continent = mkCountry "Afrique" ;
lin AN_Continent = mkCountry "Antarctique" ;
lin AS_Continent = mkCountry "Asie" ;
lin EU_Continent = mkCountry "Europe" ;
lin NA_Continent = mkCountry "Amérique du Sud" ;
lin OC_Continent = mkCountry "Oceanie" ;
lin SA_Continent = mkCountry "Amérique du Nord" ;
